...
{
  /* <div className="w-[600] h-[861px] flex-col justify-start items-center gap-10 inline-flex border border-red-500">
...
<div className="w-full h-[710px] flex-col justify-start items-start gap-4 flex">
  ...
  <input
    type="text"
    placeholder="example@email.com"
    className="w-full h-[70px] rounded-[10px] border border-[#d6ddec] px-4 text-[#8987a1] text-xl font-normal font-['Inter'] leading-[30px] bg-transparent"
  />
  <div className="text-white text-lg font-bold font-['Inter'] leading-snug">
    Email
  </div>
  ...
  <textarea
    placeholder="Write your message here..."
    className="w-full h-[222px] rounded-[10px] border border-[#d6ddec] px-4 py-4 text-[#8987a1] text-xl font-normal font-['Inter'] leading-[30px] bg-transparent"
  />
  <div className="w-full py-[19px] bg-white rounded-[10px] justify-center items-center inline-flex overflow-hidden">
